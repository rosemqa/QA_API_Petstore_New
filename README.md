# API testing of the Swagger Petstore server

This project is designed for automated API testing of the [Petstore server](https://petstore.swagger.io/).
...
[Allure Report on GitHub Pages](https://rosemqa.github.io/QA_API_Petstore_New/)
